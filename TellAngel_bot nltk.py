...
positiveArr = ["No act of kindness, no matter how small, is ever wasted. Keep it up!","It takes courage to be kind. Well done!","Let others see the good that you see in them. You're doing great!","Kindness is free - sprinkle that stuff everywhere","Love your kind message. If you were a booger, I will pick you :)","You cannot do kindness too soon, for you never know how soon it will be too late.-Ralph Waldo Emerson","Kindness is not what you do, but who you are.","Kindness is something anyone can give without losing anything themselves.","Kindness is seeing the best in others when they cannot see it in themselves." ,"When you are kind to others, it not only changes you, it changes the world. - Harold Kushner","How do we change the world? One random act of kindess at a time - Morgan Freeman","How far that little candle throws his beams! So shines a good deed in a weary world. - William Shakespeare","Know that your kindness has a ripple effect in the universe! :)", "Spread love everywhere you go!", "to kindness and love, the things we need most!", "keep it up! treat others the way you want to be treated"]
...
def start(update, context):
    update.message.reply_text("Hey, I am TellAngel, here to remind you to send kind messages to your precious friends. If this is your first time using, you are given a kindness score of 0. Else, your previous score will be used.")
